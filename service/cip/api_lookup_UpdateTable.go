...
*/
func (a *APIClient) UpdateTable(body types.LookupUpdateDefinition, id string) (types.LookupTable, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue types.LookupTable
	)

	// create path and map variables
	localVarPath := a.Cfg.BasePath + "/v1/lookupTables/{id}"
