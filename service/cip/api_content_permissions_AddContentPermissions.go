...
*/
func (a *APIClient) AddContentPermissions(body types.ContentPermissionUpdateRequest, id string, localVarOptionals *types.ContentPermissionsOpts) (types.ContentPermissionResult, *http.Response, error) {
	var (
	...
	localVarPath := a.Cfg.BasePath + "/v2/content/{id}/permissions/add"
	...
	if localVarHttpResponse.StatusCode < 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v types.ContentPermissionResult
