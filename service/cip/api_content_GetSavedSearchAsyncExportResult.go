...
/*
GetSavedSearchAsyncExportResult
Get saved search results from content export job for the given job identifier. The results from this export are incompatible with the Library import feature in the Sumo user interface.
...
func (a *APIClient) GetSavedSearchAsyncExportResult(contentId string, jobId string, localVarOptionals *types.ContentOpts) (types.SavedSearchWithScheduleSyncDefinition, *http.Response, error) {
	var (
		...
		localVarReturnValue types.SavedSearchWithScheduleSyncDefinition
	)
