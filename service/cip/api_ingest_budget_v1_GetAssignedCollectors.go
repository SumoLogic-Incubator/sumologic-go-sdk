...
func (a *APIClient) GetAssignedCollectors(id string, localVarOptionals *types.ListIngestBudgetV1Opts) (types.ListCollectorIdentitiesResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue types.ListCollectorIdentitiesResponse
	)

	// create path and map variables
	localVarPath := a.Cfg.BasePath + "/v1/ingestBudgets/{id}/collectors"
	...
	if localVarHttpResponse.StatusCode < 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v types.ListCollectorIdentitiesResponse
