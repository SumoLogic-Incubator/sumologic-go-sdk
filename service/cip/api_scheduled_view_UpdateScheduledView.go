...
*/
func (a *APIClient) UpdateScheduledView(body types.UpdateScheduledViewDefinition, id string) (types.ScheduledView, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue types.ScheduledView
	)

	// create path and map variables
	localVarPath := a.Cfg.BasePath + "/v1/scheduledViews/{id}"
