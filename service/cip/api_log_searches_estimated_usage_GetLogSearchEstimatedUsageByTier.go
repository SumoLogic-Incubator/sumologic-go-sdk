...
func (a *APIClient) GetLogSearchEstimatedUsageByTier(body types.LogSearchEstimatedUsageRequestV2) (types.LogSearchEstimatedUsageByTierDefinition, *http.Response, error) {
	var (
		...
		localVarReturnValue types.LogSearchEstimatedUsageByTierDefinition
	)

	// create path and map variables
	localVarPath := a.Cfg.BasePath + "/v1/logSearches/estimatedUsageByTier"
	...
	if localVarHttpResponse.StatusCode < 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v types.LogSearchEstimatedUsageByTierDefinition
