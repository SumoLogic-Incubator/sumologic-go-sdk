...
*/
func (a *APIClient) UpdateMonitorsById(body types.MonitorsLibraryBaseUpdate, id string) (types.MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.Cfg.BasePath + "/v1/monitors/{id}"
