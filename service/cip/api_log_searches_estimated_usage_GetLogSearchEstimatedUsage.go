...
*/
func (a *APIClient) GetLogSearchEstimatedUsage(body types.LogSearchEstimatedUsageRequest) (types.LogSearchEstimatedUsageDefinition, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue types.LogSearchEstimatedUsageDefinition
	)

	// create path and map variables
	localVarPath := a.Cfg.BasePath + "/v1/logSearches/estimatedUsage"
	...
	if localVarHttpResponse.StatusCode < 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v types.LogSearchEstimatedUsageDefinition
