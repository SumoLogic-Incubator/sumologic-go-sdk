...
func (a *APIClient) ValidateMonitorQueries(body types.MonitorQueries) (types.MonitorQueriesValidationResult, *http.Response, error) {
	var (
		...
		localVarReturnValue types.MonitorQueriesValidationResult
	)

	// create path and map variables
	localVarPath := a.Cfg.BasePath + "/v1/monitors/validateMonitorQueries"
	...
	if localVarHttpResponse.StatusCode < 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v types.MonitorQueriesValidationResult
