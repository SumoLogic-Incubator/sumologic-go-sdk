...
func (a *APIClient) GetMaxUserSessionTimeoutPolicy() (types.MaxUserSessionTimeoutPolicy, *http.Response, error) {
	var (
		...
		localVarReturnValue types.MaxUserSessionTimeoutPolicy
	)

	// create path and map variables
	localVarPath := a.Cfg.BasePath + "/v1/policies/maxUserSessionTimeout"
	...
	if localVarHttpResponse.StatusCode < 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v types.MaxUserSessionTimeoutPolicy
