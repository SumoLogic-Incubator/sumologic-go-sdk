...
*/
func (a *APIClient) CopyMonitors(body types.ContentCopyParams, id string) (types.MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.Cfg.BasePath + "/v1/monitors/{id}/copy"
